...
module.exports = {
	handleSquirrelEvent: function () {
		...
		const docDir = path.join(app.getPath("home"), 'MTG Stream Tool');
		...
		switch (squirrelEvent) {
			...
			case '--squirrel-updated':
				...
				fse.ensureDirSync(path.join(docDir, 'assets', 'card'));
				fse.ensureDirSync(path.join(docDir, 'assets', 'card', 'front'));
				fse.ensureDirSync(path.join(docDir, 'assets', 'card', 'back'));
