...
async function folder() {
    ...
    fse.ensureDirSync(path.join(resFolder, 'assets', 'card'));
    fse.ensureDirSync(path.join(resFolder, 'assets', 'card', 'front'));
    fse.ensureDirSync(path.join(resFolder, 'assets', 'card', 'back'));
}
